...
// let pacientesAvisos = pacientes.map(paciente => (...paciente, paciente['avisos'] = (!paciente.ultimaVisitaPagada) ? 'Paciente moroso, cobrar!' : ''); // TODO

let pacientesAvisos = pacientes.map(paciente => ({
    /* -------------- Spread Syntax to clone the 'paciente' object -------------- */
    /* ---------- https://www.programiz.com/javascript/spread-operator ---------- */
    ...paciente,
    avisos: (!paciente.ultimaVisitaPagada) ? 'Paciente moroso, cobrar!' : ''
  }));
